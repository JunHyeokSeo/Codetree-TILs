	...
	public static void main(String[] args) {
		...
		for (int i = 1; i < 10; i++) {
			for (int j = 1; j < 10; j++) {
				...
				if (tmp1.chars().allMatch(c -> c == ('0' + num1) || c == ('0' + num2))) success = true;
				if (tmp2.chars().allMatch(c -> c == ('0' + num1) || c == ('0' + num2))) success = true;
				if (tmp3.chars().allMatch(c -> c == ('0' + num1) || c == ('0' + num2))) success = true;
				if (tmp4.chars().allMatch(c -> c == ('0' + num1) || c == ('0' + num2))) success = true;
				if (tmp5.chars().allMatch(c -> c == ('0' + num1) || c == ('0' + num2))) success = true;
				if (tmp6.chars().allMatch(c -> c == ('0' + num1) || c == ('0' + num2))) success = true;
				if (tmp7.chars().allMatch(c -> c == ('0' + num1) || c == ('0' + num2))) success = true;
